...
return [
    'modules' => [
        ...
        'Solwin_Soldout' => 1,
        'Techsevin_BannerSlider' => 1,
        'Techsevin_CustomAddressAttribute' => 1,
        'Techsevin_CustomApi' => 1,
        'Techsevin_Customerfeedback' => 1,
        'Techsevin_HelloWorld' => 1,
        'Techsevin_Pincode' => 1,
        'Techsevin_ProductAttributes' => 1,
        'Techsevin_TextLink' => 1,
