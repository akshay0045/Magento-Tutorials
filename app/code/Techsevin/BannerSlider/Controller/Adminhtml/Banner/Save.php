...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Techsevin\BannerSlider\Model\Banner')->load($id);
    ...
    {
        return $this->_authorization->isAllowed('Techsevin_BannerSlider::banner_update') || $this->_authorization->isAllowed('Techsevin_BannerSlider::banner_create');
    }
}
